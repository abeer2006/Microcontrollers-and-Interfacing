...
int main(void)
{
  ...
  while (1)
  {
    ...
    int8_t signed_temp = (int8_t)temperature;
    myPrintf("%d\r\n", signed_temp);
    HAL_Delay(200);
    /* USER CODE END WHILE */
...
// /* USER CODE END 0 */
// uint8_t temp_cmd = 0xA6;   // Command to read temperature
// uint8_t temp_val = 0;
...
//     {
//         // After sending address, receive data
//         HAL_SPI_Receive_IT(&hspi1, &temp_val, 1);
//     }
// }
...
//         spi_rx_done = 1;                                      // Signal main loop
//     }
// }
...
//   */
// #define CTRL_REG1     0x20
// #define CTRL_REG1_VAL 0b00001111   // PD=1, X/Y/Z enabled
...
//     HAL_SPI_Transmit(&hspi1, tx, 2, HAL_MAX_DELAY);           // Send register + data
//     HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3, GPIO_PIN_SET);       // CS HIGH
// }
...
//   uint8_t temp_cmd = 0xA6;  // 0x26 | 0x80 -> read TEMP register
// uint8_t temp_val = 0;
...
//     HAL_SPI_Receive(&hspi1, &temp_val, 1, HAL_MAX_DELAY);
//     HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3, GPIO_PIN_SET);     // CS HIGH
